        ...
        <div className="col-span-2 relative group">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                block w-full pl-9 pr-4 py-3 bg-white border-2 rounded-xl text-gray-900
                placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-100
                transition-all 
        ...
        <div className="col-span-1 relative group">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                block w-full pl-9 pr-4 py-3 bg-white border-2 border-gray-100 rounded-xl
                text-gray-900placeholder-gray-400 focus:outline-none focus:ring-4 
      ...
      <div className="relative group">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="block w-full pl-9 pr-4 py-3 bg-white border-2 border-gray-100 rounded-xl text-gray-900
            placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-100 focus:border-purple-500
            transition-all resize-none"
            placeholder="Путешествия, программирование, котики..."
          ></textarea>
        </div>
      </div>
    </section>
